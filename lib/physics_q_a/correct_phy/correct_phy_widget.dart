...
import 'correct_phy_model.dart';
export 'correct_phy_model.dart';

class CorrectPhyWidget extends StatefulWidget {
  const CorrectPhyWidget({
    super.key,
  ...
  @override
  _CorrectPhyWidgetState createState() => _CorrectPhyWidgetState();
}

class _CorrectPhyWidgetState extends State<CorrectPhyWidget> {
  late CorrectPhyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CorrectPhyModel());
