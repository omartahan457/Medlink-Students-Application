...
class QuestionsPage2Widget extends StatefulWidget {
  const QuestionsPage2Widget({super.key});

  @override
  _QuestionsPage2WidgetState createState() => _QuestionsPage2WidgetState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<MedicalYears1Record>>(
      ...
      builder: (context, snapshot) {
        ...
        List<MedicalYears1Record> questionsPage2MedicalYears1RecordList =
            snapshot.data!;
        return Title(
            title: 'QuestionsPage2',
                        ...
                        children: [
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                10.0, 10.0, 0.0, 0.0),
                            child: Text(
                              questionsPage2MedicalYears1RecordList[
                                      _model.randomNumber!]
                                  .question,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                            ...
                            children: [
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    if (questionsPage2MedicalYears1RecordList
                                            .first.wrong1 ==
                                        questionsPage2MedicalYears1RecordList
                                            .first.answer) {
                                      context.pushNamed(
