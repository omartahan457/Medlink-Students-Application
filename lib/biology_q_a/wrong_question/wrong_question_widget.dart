...
import 'wrong_question_model.dart';
export 'wrong_question_model.dart';

class WrongQuestionWidget extends StatefulWidget {
  const WrongQuestionWidget({
    super.key,
  ...
  @override
  _WrongQuestionWidgetState createState() => _WrongQuestionWidgetState();
}

class _WrongQuestionWidgetState extends State<WrongQuestionWidget> {
  late WrongQuestionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WrongQuestionModel());
