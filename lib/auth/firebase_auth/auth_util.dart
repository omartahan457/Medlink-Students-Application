...
DocumentReference? get currentUserReference =>
    loggedIn ? MedlinkStudentsDBRecord.collection.doc(currentUser!.uid) : null;

MedlinkStudentsDBRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : MedlinkStudentsDBRecord.getDocument(
                  MedlinkStudentsDBRecord.collection.doc(uid))
              .handleError((_) {}),
    )
