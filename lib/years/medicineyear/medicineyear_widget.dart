...
class MedicineyearWidget extends StatefulWidget {
...
class _MedicineyearWidgetState extends State<MedicineyearWidget>
    with TickerProviderStateMixin {
  late MedicineyearModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MedicineyearModel());
