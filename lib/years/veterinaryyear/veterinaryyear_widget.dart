...
class VeterinaryyearWidget extends StatefulWidget {
...
class _VeterinaryyearWidgetState extends State<VeterinaryyearWidget>
    with TickerProviderStateMixin {
  late VeterinaryyearModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VeterinaryyearModel());
