...
import 'correct_chem_model.dart';
export 'correct_chem_model.dart';

class CorrectChemWidget extends StatefulWidget {
  const CorrectChemWidget({
    super.key,
  ...
  @override
  _CorrectChemWidgetState createState() => _CorrectChemWidgetState();
}

class _CorrectChemWidgetState extends State<CorrectChemWidget> {
  late CorrectChemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CorrectChemModel());
